locals {
  data_zone_id     = length(data.aws_route53_zone.pcf_zone) > 0 ? data.aws_route53_zone.pcf_zone.0.zone_id : ""
  resource_zone_id = length(aws_route53_zone.pcf_zone) > 0 ? aws_route53_zone.pcf_zone.0.zone_id : ""
